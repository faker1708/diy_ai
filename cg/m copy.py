...
class dnn():
    ...
    def fa(self):
        ...
        for ii in range(8):
            ...
            true_y = torch.where(true_y>0,1,0)
            ...
            print('true_y',true_y)
            # print("diff_y",y-true_y)
            print("loss",(y-true_y)**2)
            # print('true_y',true_y[0])
            print('\n\n')
